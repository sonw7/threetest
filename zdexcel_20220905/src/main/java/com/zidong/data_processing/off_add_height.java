...
public class off_add_height {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //表示一个文件路径
        File file1 = new File("D:\\项目代码\\层间距\\");
        //用数组把文件夹下的文件存起来
    ...
    public static Boolean writeFaultTxt(int faultnum,String Faultname[],int VTnum [][],List<List<vertex>> vertices,List<List<triangle>> triangles) throws IOException {
        String offPath = "D:\\项目代码\\层间距 增加\\1.off";
...
//        out.write(faultnum + "\n");
        out.write("OFF" + "\n");
        out.write(vertices.get(0).size() +" "+triangles.get(0).size()+" "+0+ "\n");
