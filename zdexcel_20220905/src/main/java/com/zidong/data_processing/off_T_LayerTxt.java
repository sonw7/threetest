...
public class off_T_LayerTxt {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //表示一个文件路径
        File file1 = new File("D:\\项目代码\\1114\\DC11092130\\moxing2\\");
        //用数组把文件夹下的文件存起来
                ...
                try
                {
                    ...
                    while((text = bufferedReader.readLine()) != null)
                    {
                        if(i!=0){
                            ...
                            String[] st = row.split(" ");
                            triangle t = new triangle(Integer.parseInt(st[1]),Integer.parseInt(st[2]),Integer.parseInt(st[3]));
                            triangleList.add(t);
                            Tnum--;
        ...
        writeLayerTxt(filespath.length,OFFfilesname,VTnum,allvertexlist,alltrianglelist);
    }
    ...
    public static Boolean writeLayerTxt(int layernum,String Faultname[],int VTnum [][],List<List<vertex>> vertices,List<List<triangle>> triangles) throws IOException {
        String offPath = "D:\\项目代码\\1114\\DC11092130\\Layer\\Toplayer1.txt";
